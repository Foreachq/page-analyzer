...
lint:
	docker-compose run web composer exec --verbose phpcs -- --standard=PSR12 routes/web.php app/Http/Controllers app/Http/Requests app/Models database/Repositories app/Utils tests/Unit tests/Feature
